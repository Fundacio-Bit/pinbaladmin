...
@XmlRootElement(name = "Transmision", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta")
public class Transmision {
    ...
    @XmlElement(name = "IdSolicitud", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", required = true)
    protected String idSolicitud;
    @XmlElement(name = "IdTransmision", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", required = true)
    protected String idTransmision;
    @XmlElement(name = "FechaGeneracion", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", required = true)
