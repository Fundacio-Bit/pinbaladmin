...
@XmlRootElement(name = "Solicitudes", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/peticion")
public class Solicitudes {

    @XmlElement(name = "SolicitudTransmision", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/peticion", required = true)
