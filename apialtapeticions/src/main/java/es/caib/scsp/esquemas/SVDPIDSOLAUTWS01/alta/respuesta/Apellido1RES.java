...
public class Apellido1RES
    extends JAXBElement<String>
{

    protected final static QName NAME = new QName("http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", "Apellido1");

    public Apellido1RES(String value) {
