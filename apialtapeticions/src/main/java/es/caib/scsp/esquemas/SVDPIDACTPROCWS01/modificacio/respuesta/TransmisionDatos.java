...
@XmlRootElement(name = "TransmisionDatos", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta")
public class TransmisionDatos {

    @XmlElement(name = "DatosGenericos", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", required = true)
