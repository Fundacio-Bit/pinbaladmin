...
public class Titular {
    ...
    @XmlElement(name = "Apellido1", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta")
    protected String apellido1;
    @XmlElement(name = "Apellido2", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta")
