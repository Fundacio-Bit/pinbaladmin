...
public class NombreRES
    extends JAXBElement<String>
{

    protected final static QName NAME = new QName("http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", "Nombre");

    public NombreRES(String value) {
