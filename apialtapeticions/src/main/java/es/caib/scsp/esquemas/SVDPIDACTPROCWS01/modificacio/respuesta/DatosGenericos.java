...
@XmlRootElement(name = "DatosGenericos", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta")
public class DatosGenericos {

    @XmlElement(name = "Emisor", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", required = true)
    protected Emisor emisor;
    @XmlElement(name = "Solicitante", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", required = true)
    protected Solicitante solicitante;
    @XmlElement(name = "Titular", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta")
    protected Titular titular;
    @XmlElement(name = "Transmision", namespace = "http://intermediacion.redsara.es/scsp/esquemas/V3/respuesta", required = true)
