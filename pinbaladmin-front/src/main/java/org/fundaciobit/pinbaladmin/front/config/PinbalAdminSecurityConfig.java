...
@EnableWebSecurity
@Profile("!https")
@ComponentScan(basePackages = { "org.fundaciobit.pinbaladmin.front", "org.fundaciobit.pluginsib.login.springutils" })
public class PinbalAdminSecurityConfig extends WebSecurityConfigurerAdapter {
