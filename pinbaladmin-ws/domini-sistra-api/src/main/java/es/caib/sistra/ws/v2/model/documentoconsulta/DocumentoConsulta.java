...
public class DocumentoConsulta {
    ...
    @XmlElementRef(name = "plantilla", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "nombreFichero", type = JAXBElement.class, required = false)
    protected JAXBElement<String> nombreFichero;
    @XmlElementRef(name = "urlAcceso", type = JAXBElement.class, required = false)
    protected JAXBElement<String> urlAcceso;
    @XmlElementRef(name = "urlNuevaVentana", type = JAXBElement.class, required = false)
