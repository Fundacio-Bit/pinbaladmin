...
public class SistraFacadeService extends Service {
    ...
    static {
        URL url = SistraFacadeService.class.getResource("SistraFacade.wsdl");
        if (url == null) {
            url = SistraFacadeService.class.getClassLoader().getResource("SistraFacade.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(SistraFacadeService.class.getName())
