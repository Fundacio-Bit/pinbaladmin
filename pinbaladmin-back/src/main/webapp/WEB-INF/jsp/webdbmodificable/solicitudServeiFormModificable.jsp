...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		function testNormes() {
			console.log("añadiremos " + normesAfegides + " normas");
			...
			//Si solo hay una norma, no se puede eliminar, y si hay 3, no se puede a�adir
			if (normesAfegides > 1) {
                $("#eliminarNorma").show();
            } else {
                $("#eliminarNorma").hide();
		...
		function preValidate() {
			  ...
			  if (!hasFile || !hasNormaLegal || !hasCaducaDate) {
			    ...
			    alert("El formulario està sin rellenar. Faltan: " + missingFields.join(", "));
			    return false;
			  }
		...
		// onsubmit, poner vacíos los campos de normas que no están visibles
		$("form").submit(function(event) {
		  ...
		  // Asignar funci�n al cambio del select SIN borrar otros handlers
