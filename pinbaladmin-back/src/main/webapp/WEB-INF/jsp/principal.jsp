...
<br/>
<center>
<img src="<c:url value="/img/app-logo.png"/>"  alt="PinbalAdmin" title="PinbalAdmin"/>

<br/>
<br/>
Administració de les Peticions d'Alta a PINBAL per part de les entitats de les Illes Balears. 
...
&#36;{pad:hasRole(ROLE_ADMIN)}= ${pad:hasRole('ROLE_ADMIN')}<br/>
&#36;{pad:hasRole(ROLE_USER) }= ${pad:hasRole('ROLE_USER') }<br/>
