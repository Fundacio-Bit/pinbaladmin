<%@   taglib prefix="spring" uri="http://www.springframework.org/tags"%><%@ taglib
	...
	prefix="un" uri="http://jakarta.apache.org/taglibs/unstandard-1.0"%><%@ taglib
	prefix="sec" uri="http://www.springframework.org/security/tags"%><%@ taglib
	prefix="pad" uri="/WEB-INF/jstl/pinbaladmin.tld"%><%@ taglib
	prefix="gen" uri="/WEB-INF/jstl/genapp.tld"%><%@ page
	errorPage="/error.jsp" trimDirectiveWhitespaces="true"%>
