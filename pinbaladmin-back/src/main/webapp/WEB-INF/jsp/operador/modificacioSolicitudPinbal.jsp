...
<a id="button-modifica-solicitud" class="btn btn-primary"
	onclick="altaSolicitud()"> <i class="fas fa-cloud-upload-alt"></i>
	&nbsp; Modificar Solicitud
</a>


<h3>Vista previa Modificacio solicitud</h3>

<form id="formulari"
	action="<c:url value="/operador/altapinbal/modificaciosolicitud"/>"
