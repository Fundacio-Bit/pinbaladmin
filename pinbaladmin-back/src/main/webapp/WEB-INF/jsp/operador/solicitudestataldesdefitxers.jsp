...
.containerDAD h1 a:hover, .containerDAD h1 a:focus {
	color: #39bfd3;
}
...
.containerDAD nav a:not( .is-selected ):hover, .containerDAD nav a:not( .is-selected ):focus
	{
...
.containerDAD footer p+p {
	margin-top: 1em;
}

.containerDAD footer a:hover, .containerDAD footer a:focus {
	color: #39bfd3;
}
...
.js .box__file+label:hover strong, .box__file:focus+label strong,
...
<div class="containerDAD" role="main">

	<form id="theform" method="post"
		action="${pageContext.servletContext.contextPath}/operador/solicitudestataldesdefitxers/uploadMultiFile"
		enctype="multipart/form-data" novalidate=""
		class="box has-advanced-upload">

		<h4>Crear Sol&middot;licitud Estatal des d'un Fitxer de Correu
			(msg o eml) o des d'un fitxer .xlsx</h4>
		...
		<div class="box__input">
			...
			<label for="file"> <strong>Seleccioni un fitxer .msg
					o .eml o .xlsx</strong><span class="box__dragndrop"> o arrossegui'l
					fins aqu&iacute;</span>.
			</label>
		...
		<div class="box__success">
			Done!
			<%--  <a href="https://css-tricks.com/examples/DragAndDropFileUploading//?submit-on-demand" class="box__restart" role="button">Upload more?</a> --%>
		</div>
		<div class="box__error">
			Error!
			<%-- <span></span>. <a href="https://css-tricks.com/examples/DragAndDropFileUploading//?submit-on-demand" class="box__restart" role="button">Try again!</a> --%>
		</div>
				...
				.call(
						...
						function(form) {
							var input = form
									...
									.querySelector('.box__error span'), restart = form
									.querySelectorAll('.box__restart'), droppedFiles = false, showFiles = function(
									files) {
												...
												if (isAdvancedUpload) // ajax file upload for modern browsers
												{
													...
													ajax.onload = function() {
														...
														if (ajax.status == 200) {
															...
															//alert("Rebut del servidor: " + data);
															//alert("Data Rebuda: ]" + data + "[");
															window.location.href = '<c:url value="/operador/solicitudestatal/list" />/'
																	+ data;
