...
<h4>Crear Sol&middot;licitud Estatal des d'un Fitxer de Correu (msg o eml) o des d'un fitxer .xlsx</h4>
        ...
        <div class="box__input">
            ...
            <input type="file" name="files[]" id="file" class="box__file"
                ...
                <label for="file">
                 <strong>Seleccioni un fitxer .msg o .eml o .xlsx</strong><span class="box__dragndrop"> o arrossegui'l fins aqu&iacute;</span>.
                </label>
                                                ...
                                                if (isAdvancedUpload) // ajax file upload for modern browsers
                                                {
                                                    ...
                                                    ajax.onload = function() {
                                                        ...
                                                        if (ajax.status == 200) {
                                                            ...
                                                            window.location.href = '<c:url value="/operador/solicitudestatal/list" />/' + data;
