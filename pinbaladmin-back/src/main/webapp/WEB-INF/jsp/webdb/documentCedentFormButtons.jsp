...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
  ...
  <div class="navbar-form" style="text-align:right">
    ...
    <input type="button" class="btn btn-secondary" onclick="goTo('<c:url value="${contexte}/${__theForm.documentCedent.documentCedentID}/cancel"/>')" value="<fmt:message key="genapp.cancel"/>">
    </c:if>
