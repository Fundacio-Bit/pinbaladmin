...
<un:useConstants var="TipusTiquetFields" className="org.fundaciobit.pinbaladmin.model.fields.TipusTiquetFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusTiquetFields.TIPUSTIQUETID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="tipusTiquet.tipusTiquetID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TipusTiquetFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tipusTiquet.nom" var="nom" />
