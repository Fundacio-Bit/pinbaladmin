...
<un:useConstants var="FitxerFields" className="org.fundaciobit.pinbaladmin.model.fields.FitxerFields"/>
        ...
        <tr id="fitxer_mime_rowid">
          ...
          <td id="fitxer_mime_columnvalueid">
            ...
            <form:input readonly="${ gen:contains(__theForm.readOnlyFields ,FitxerFields.MIME)? 'true' : 'false'}" cssClass="w-100 form-control  ${gen:contains(__theForm.readOnlyFields ,FitxerFields.MIME)? ' uneditable-input' : ''}"  style="" maxlength="100" path="fitxer.mime"   />
