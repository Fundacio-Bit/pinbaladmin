        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,PinfoFields.ESTAT)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="pinfo_estat_select" path="estatSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
