...
<un:useConstants var="TramitGDadesTitFields" className="org.fundaciobit.pinbaladmin.model.fields.TramitGDadesTitFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitGDadesTitFields.DADESTITID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="tramitGDadesTit.dadestitid" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="dadestitidDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="dadestitidFins" />

            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitGDadesTitFields.TRAMITID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="tramitGDadesTit.tramitid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitGDadesTitFields.NIF)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitGDadesTit.nif" var="nif" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitGDadesTitFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitGDadesTit.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitGDadesTitFields.LLINATGE1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitGDadesTit.llinatge1" var="llinatge1" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitGDadesTitFields.LLINATGE2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitGDadesTit.llinatge2" var="llinatge2" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitGDadesTitFields.CARREC)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitGDadesTit.carrec" var="carrec" />
