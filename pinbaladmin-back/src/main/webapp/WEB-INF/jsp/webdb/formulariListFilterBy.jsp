...
<un:useConstants var="FormulariFields" className="org.fundaciobit.pinbaladmin.model.fields.FormulariFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,FormulariFields.FORMULARIID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="formulari.formulariid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,FormulariFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="formulari.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,FormulariFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="formulari.descripcio" var="descripcio" />
