...
<un:useConstants var="OrganFields" className="org.fundaciobit.pinbaladmin.model.fields.OrganFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,OrganFields.ORGANID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="organ.organid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,OrganFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="organ.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,OrganFields.DIR3)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="organ.dir3" var="dir3" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,OrganFields.DIR3PARE)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="organ.dir3pare" var="dir3pare" />
              <fmt:message key="genapp.form.searchby" var="cercaperdir3pare" >                
                 <fmt:param value="${dir3pare}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${dir3pare}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercaperdir3pare}" path="dir3pare" />
            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,OrganFields.ENTITATID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="organ.entitatid" />:</span>
