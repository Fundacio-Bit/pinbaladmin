...
<label style="font-size: 1.25rem;font-weight: bold;">
  ...
  <c:if test="${fn:length(groupby_items) > 0}">
    ...
    <c:if test="${__theFilterForm.deleteSelectedButtonVisible && __theFilterForm.visibleMultipleSelection && not empty tramitDCteAutItems}">
      <a class="btn btn-danger btn-sm float-right botoselecciolist" style="" href="#myModal"
        onclick="openModalSubmit('<c:url value="${contexte}/deleteSelected"/>','show', 'tramitDCteAut');"
