...
<un:useConstants var="ContacteFields" className="org.fundaciobit.pinbaladmin.model.fields.ContacteFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.CONTACTEID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="contacte.ContacteID" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="ContacteIDDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="ContacteIDFins" />

            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.NIF)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.nif" var="nif" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.LLINATGE1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.llinatge1" var="llinatge1" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.LLINATGE2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.llinatge2" var="llinatge2" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.CARREC)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.carrec" var="carrec" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.TELEFON)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.telefon" var="telefon" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.MAIL)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.mail" var="mail" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.USERNAME)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.username" var="username" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,ContacteFields.NOMBRECOMPLETO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="contacte.nombrecompleto" var="nombrecompleto" />
              <fmt:message key="genapp.form.searchby" var="cercapernombrecompleto" >                
                 <fmt:param value="${nombrecompleto}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${nombrecompleto}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercapernombrecompleto}" path="nombrecompleto" />
            </div>
