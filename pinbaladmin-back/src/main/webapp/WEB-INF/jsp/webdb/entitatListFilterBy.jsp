...
<un:useConstants var="EntitatFields" className="org.fundaciobit.pinbaladmin.model.fields.EntitatFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatFields.PERSONACONTACTE)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entitat.personaContacte" var="personaContacte" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatFields.CIF)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entitat.CIF" var="CIF" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatFields.GRUPENTITATID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entitat.grupEntitatID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatFields.CONVENIPMSBAE)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entitat.convenipmsbae" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="convenipmsbaeDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="convenipmsbaeFins" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatFields.CODIPINBAL)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entitat.codiPinbal" var="codiPinbal" />
              <fmt:message key="genapp.form.searchby" var="cercapercodiPinbal" >                
                 <fmt:param value="${codiPinbal}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${codiPinbal}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercapercodiPinbal}" path="codiPinbal" />
            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatFields.GESTIONATPERGOVERNDIGITAL)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entitat.gestionatPerGovernDigital" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="gestionatPerGovernDigitalDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="gestionatPerGovernDigitalFins" />
