...
<un:useConstants var="TramitFCteTecFields" className="org.fundaciobit.pinbaladmin.model.fields.TramitFCteTecFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.CTETECID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="tramitFCteTec.ctetecid" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="ctetecidDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="ctetecidFins" />

            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.TRAMITID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="tramitFCteTec.tramitid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.NIF)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitFCteTec.nif" var="nif" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitFCteTec.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.LLINATGE1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitFCteTec.llinatge1" var="llinatge1" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.LLINATGE2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitFCteTec.llinatge2" var="llinatge2" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.CARREC)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitFCteTec.carrec" var="carrec" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.TELEFON)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitFCteTec.telefon" var="telefon" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitFCteTecFields.MAIL)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitFCteTec.mail" var="mail" />
