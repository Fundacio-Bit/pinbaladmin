...
<un:useConstants var="EntitatServeiFields" className="org.fundaciobit.pinbaladmin.model.fields.EntitatServeiFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatServeiFields.ENTITATSERVEIID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entitatServei.entitatServeiID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatServeiFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entitatServei.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatServeiFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="entitatServei.descripcio" var="descripcio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EntitatServeiFields.BALEARS)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="entitatServei.balears" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="balearsDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="balearsFins" />
