...
<%-- FILTRE DATE-TIME --%>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,IncidenciaTecnicaFields.ESTAT)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="inctecnica_estat_select" path="estatSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#inctecnica_estat_select').select2({
                        closeOnSelect: false
                    });
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,IncidenciaTecnicaFields.TIPUS)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="inctecnica_tipus_select" path="tipusSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
              ...
              <script type="text/javascript">
                $(document).ready(function() {
                    $('#inctecnica_tipus_select').select2({
                        closeOnSelect: false
                    });
                    $('.select2-selection__rendered').css('padding-bottom','5px');
                });
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,IncidenciaTecnicaFields.ORGANID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="incidenciaTecnica.organid" />:</span>
