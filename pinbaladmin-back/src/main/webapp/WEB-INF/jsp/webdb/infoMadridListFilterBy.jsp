...
<%-- FILTRE DATE-TIME --%>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,InfoMadridFields.DATACONSULTA)}">
<%-- FILTRE DATE-TIME --%>
            <div class="input-group" style="padding-right:4px;padding-bottom:4px;align-items:center;">
              <span class="add-on"><fmt:message key="infoMadrid.dataConsulta" />:</span>
              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
            <div class="form-group"  style="margin-bottom: 0px;" >
                <div class="input-group date" id="dataConsultaDesde" data-target-input="nearest">
                      <form:input  cssClass="form-control datetimepicker-input"  data-target="#dataConsultaDesde" path="dataConsultaDesde" />
                    <c:if test="${!false}" >
                    <div class="input-group-append"  data-target="#dataConsultaDesde"  data-toggle="datetimepicker">
                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                    </div>
                    </c:if>
                </div>
        ...
        <script type="text/javascript">
            $(function () {
                $('#dataConsultaDesde').datetimepicker({
                    format: '${gen:getJSDateTimePattern()}',
                    locale: '${lang}',
                    icons: {
                       time: 'far fa-clock'
            ...
            <div class="form-group"  style="margin-bottom: 0px;" >
                <div class="input-group date" id="dataConsultaFins" data-target-input="nearest">
                      <form:input  cssClass="form-control datetimepicker-input"  data-target="#dataConsultaFins" path="dataConsultaFins" />
                    <c:if test="${!false}" >
                    <div class="input-group-append"  data-target="#dataConsultaFins"  data-toggle="datetimepicker">
                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                    </div>
                    </c:if>
                </div>
        ...
        <script type="text/javascript">
            $(function () {
                $('#dataConsultaFins').datetimepicker({
                    format: '${gen:getJSDateTimePattern()}',
                    locale: '${lang}',
                    icons: {
                       time: 'far fa-clock'
