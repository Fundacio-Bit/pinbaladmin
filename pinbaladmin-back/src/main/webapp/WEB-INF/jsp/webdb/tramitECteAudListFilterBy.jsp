...
<un:useConstants var="TramitECteAudFields" className="org.fundaciobit.pinbaladmin.model.fields.TramitECteAudFields"/>
  ...
  <div id="FilterDiv" class="wellgroupfilter formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.CTEAUDID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="tramitECteAud.cteaudid" />:</span>

              <span class="add-on">&nbsp;<fmt:message key="genapp.from" /></span>
              
              <form:input cssClass="input-append input-small" path="cteaudidDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="cteaudidFins" />

            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.TRAMITID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
            <%-- FILTRE NUMERO DESDE-FINS --%>
              <span class="add-on"><fmt:message key="tramitECteAud.tramitid" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.NIF)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitECteAud.nif" var="nif" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitECteAud.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.LLINATGE1)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitECteAud.llinatge1" var="llinatge1" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.LLINATGE2)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitECteAud.llinatge2" var="llinatge2" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.CARREC)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitECteAud.carrec" var="carrec" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.TELEFON)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitECteAud.telefon" var="telefon" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,TramitECteAudFields.MAIL)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="tramitECteAud.mail" var="mail" />
