      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,DocumentSolicitudFields.DOCUMENTSOLICITUDID)}">
            ...
            <%-- FILTRE NUMERO DESDE-FINS --%>
              ...
              <form:input cssClass="input-append input-small" path="documentSolicitudIDDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="documentSolicitudIDFins" />
