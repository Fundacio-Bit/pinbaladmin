...
<script type="text/javascript"
	src="<c:url value="/ayuda/js/jquery/jquery.js"/>"></script>

<script type="text/javascript"
	src="<c:url value="/ayuda/js/jquery/jquery-ui.js"/>"></script>

<script type="text/javascript"
	src="<c:url value="/ayuda/js/morfos/main.js"/>"></script>
...
<
br> </div> <div class ="container "> <c:forEach var ="event " items ="${eventItems
...
c:set var ="isPublic " value ="${event .tipus > 0
    ...
    set var = "isContacte "value="${event .tipus == 2

    }

    "/><c:
    set var = "show "value="true "/><c:if test="${showOnlyPublic==true&&isPublic==false

    }

    "><c:
    set var = "show "value="false "/></c:if><c:if test="${show

    }

    "><c:
    set var = "background "value="#cce6ff "/><c:
    set var = "border "value="#F0E68C "/><c:if test="${ !isPublic

    }

    "><c:
    set var = "background "value="#ffb3b3 "/><c:
    set var = "border "value="#ff0000 "/></c:if><c:if test="${isContacte

    }

    "><c:
    set var = "background "value="#ccffcc "/><c:
    set var = "border "value="#9ACD32 "/></c:if><c:if test="${isContacte
    ...
    file="/WEB-INF/jsp/common/eventscore.jsp"%></div><div

    class="timeline-date"

    style="left:

    -190 px;">${event.dataEvent}<br><span
    ...
    ${event.persona}</span></div></div></div></div></c:if><c:if test="${ !isContacte
    ...
    file="/WEB-INF/jsp/common/eventscore.jsp"%><div

    class="timeline-date">${event.dataEvent}<br><span
    ...
    ${event.persona}</span></div></div></div></div></c:if></c:if></c:forEach></div></div></div></div></div><%--

    <form

    id="formularioMensaje"

    name="formularioMensaje"

    action="/ayuda/seguimientoEnviarMensaje"
    ...
    </div></fieldset></form>--%><br/><br/><center><b>©Fundaci&oacute
    ...
    PinbalAdmin</b></center><%--

    <div

    id="footer"><p>©Fundaci&oacute
    ...
    value="/ayuda/images/morfos/ajax-loader.gif"/>"></div><div
    ...
    ui-helper-hidden-accessible"></div><div
    ...
    aria-labelledby="ui-dialog-title-AjaxShow"><div
    ...
    id="ui-dialog-title-AjaxShow">&nbsp;</span><a
    ...
    ui-icon-closethick">close</span></a></div><div

    id="AjaxShow"

    class="ui-dialog-content

    ui-widget-content"></div>--%></div>