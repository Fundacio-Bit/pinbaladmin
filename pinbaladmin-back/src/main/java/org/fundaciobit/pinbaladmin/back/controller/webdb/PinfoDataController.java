 ...
 * @author GenApp
 */
@MenuOption(labelCode="pinfoData.pinfoData.plural", order=220, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/pinfoData")
@SessionAttributes(types = { PinfoDataForm.class, PinfoDataFilterForm.class })
@Tile(name="pinfoDataFormWebDB", contentJsp="/WEB-INF/jsp/webdb/pinfoDataForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="pinfoData.pinfoData")})
@Tile(name="pinfoDataListWebDB", contentJsp="/WEB-INF/jsp/webdb/pinfoDataList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="pinfoData.pinfoData") })
