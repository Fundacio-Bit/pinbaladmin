 ...
 * @author GenApp
 */
@MenuOption(labelCode="tramitJConsent.tramitJConsent.plural", order=390, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de TramitJConsent
   */
  @RequestMapping(value = "/cancel")
  public String cancelTramitJConsent(HttpServletRequest request,HttpServletResponse response) {
