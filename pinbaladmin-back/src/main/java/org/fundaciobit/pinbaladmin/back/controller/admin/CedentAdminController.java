 ...
 */
@Controller
@RequestMapping(value = "/admin/cedent")
@SessionAttributes(types = { EntitatServeiForm.class, EntitatServeiFilterForm.class })
public class CedentAdminController extends EntitatServeiController {
    ...
    public String getTileForm() {
        return "entitatServeiFormWebDB_admin";
    }

    @Override
    public String getTileList() {
        return "entitatServeiListWebDB_admin";
    }
    ...
    public EntitatServeiFilterForm getEntitatServeiFilterForm(Integer pagina, ModelAndView mav,
        ...
        if (entitatServeiFilterForm.isNou()) {
            ...
            entitatServeiFilterForm.addAdditionalButtonForEachItem(new AdditionalButton(IconUtils.ICON_FILE,
                    "documentscedent", "/admin/cedent/documents/{0}", AdditionalButtonStyle.INFO));
    ...
    public ModelAndView veureDocumentCedentGet(@PathVariable("entitatSerceiID") java.lang.Long entitatSerceiID,
        ...
        request.getSession().setAttribute(DocumentCedentAdminController.CEDENTID_SESSION_PROPERTY, entitatSerceiID);

        return new ModelAndView(new RedirectView("/admin/documentcedent/list", true));
