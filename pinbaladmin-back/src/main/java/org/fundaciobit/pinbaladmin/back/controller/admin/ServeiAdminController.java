 ...
 */
@Controller
@RequestMapping(value = "/admin/servei")
@SessionAttributes(types = { ServeiForm.class, ServeiFilterForm.class })
public class ServeiAdminController extends ServeiController {
    ...
    public String getTileForm() {
        return "serveiFormWebDB_admin";
    }

    @Override
    public String getTileList() {
        return "serveiListWebDB_admin";
    }
    
    @Override
    public String getSessionAttributeFilterForm() {
        return "ServeiWebDB_FilterForm_admin";
    }
