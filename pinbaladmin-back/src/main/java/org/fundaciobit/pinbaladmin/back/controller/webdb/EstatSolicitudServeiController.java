...
public class EstatSolicitudServeiController
  ...
  public String editarEstatSolicitudServeiPost(@ModelAttribute EstatSolicitudServeiForm estatSolicitudServeiForm,
  ...
  public String eliminarEstatSolicitudServei(@PathVariable("estatSolicitudServeiID") java.lang.Long estatSolicitudServeiID,
    ...
    try {
      EstatSolicitudServei estatSolicitudServei = this.findByPrimaryKey(request, estatSolicitudServeiID);
      if (estatSolicitudServei == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, EstatSolicitudServei estatSolicitudServei) throws I18NException {
