 ...
 * @author GenApp
 */
@MenuOption(labelCode="campFormulari.campFormulari.plural", order=10, group=Tab.MENU_WEBDB)
@Controller
...
public class CampFormulariController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.CampFormulariService.JNDI_NAME)
  ...
  public String editarCampFormulariPost(@ModelAttribute CampFormulariForm campFormulariForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de CampFormulari
   */
  @RequestMapping(value = "/cancel")
  public String cancelCampFormulari(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "CampFormulari_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, CampFormulari campFormulari) throws I18NException {
