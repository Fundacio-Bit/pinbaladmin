 ...
 */
@Controller
@RequestMapping(value = "/operador/fitxer")
@SessionAttributes(types = { FitxerForm.class, FitxerFilterForm.class })
public class FitxerOperadorController extends FitxerController {
    ...
    public String getTileForm() {
        return "fitxerForm_operador";
    }

    @Override
    public String getTileList() {
        return "fitxerList_operador";
    }
