 ...
 * @author GenApp
 */
@MenuOption(labelCode="tramitIServ.tramitIServ.plural", order=410, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de TramitIServ
   */
  @RequestMapping(value = "/cancel")
  public String cancelTramitIServ(HttpServletRequest request,HttpServletResponse response) {
