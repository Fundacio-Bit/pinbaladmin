...
public class EstatServeiController
  ...
  public String editarEstatServeiPost(@ModelAttribute EstatServeiForm estatServeiForm,
  ...
  public String eliminarEstatServei(@PathVariable("estatServeiID") java.lang.Long estatServeiID,
    ...
    try {
      EstatServei estatServei = this.findByPrimaryKey(request, estatServeiID);
      if (estatServei == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, EstatServei estatServei) throws I18NException {
