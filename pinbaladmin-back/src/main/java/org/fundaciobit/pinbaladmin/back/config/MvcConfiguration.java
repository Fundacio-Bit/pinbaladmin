package org.fundaciobit.pinbaladmin.back.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"org.fundaciobit.pinbaladmin"})
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter {
	...
	public LocaleResolver localeResolver() {
	    SessionLocaleResolver slr = new org.fundaciobit.pinbaladmin.back.utils.PinbalAdminSessionLocaleResolver();
	...
	public BeanPostProcessor beanPostProcessor() {
	    return new org.fundaciobit.pinbaladmin.back.security.DefaultRolesPrefixPostProcessor();
	}

	@Bean
	public MultipartResolver multipartResolver() {
		return new org.fundaciobit.pinbaladmin.back.utils.PinbalAdminCommonsMultipartResolver();
	}

	@Bean
	public HandlerExceptionResolver getFileSizeExceeds() {
	  return new org.fundaciobit.pinbaladmin.back.utils.PinbalAdminMaxUploadSizeExceededExceptionHandler();
	}
	...
	public MessageSource messageSource() {
		...
		messageSource.addBasenames("/WEB-INF/classes/missatges", "/WEB-INF/classes/logicmissatges",
				"/WEB-INF/classes/pinbaladmin_genapp", "/WEB-INF/classes/genapp");
