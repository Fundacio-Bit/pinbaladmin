...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Departament
   */
  @RequestMapping(value = "/cancel")
  public String cancelDepartament(HttpServletRequest request,HttpServletResponse response) {
