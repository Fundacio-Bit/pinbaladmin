...
import org.fundaciobit.pinbaladmin.back.form.webdb.TraduccioForm;

import org.fundaciobit.pinbaladmin.back.validator.webdb.TraduccioWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="traduccio.traduccio.plural", order=300, group=Tab.MENU_WEBDB)
@Controller
...
public class TraduccioController
    extends org.fundaciobit.pinbaladmin.back.controller.PinbalAdminBaseController<Traduccio, java.lang.Long> implements TraduccioFields {

  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.TraduccioService.JNDI_NAME)
  protected org.fundaciobit.pinbaladmin.ejb.TraduccioService traduccioEjb;
