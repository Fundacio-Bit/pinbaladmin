 ...
 * @author GenApp
 */
@MenuOption(labelCode="operador.operador.plural", order=230, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Operador
   */
  @RequestMapping(value = "/cancel")
  public String cancelOperador(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "Operador_FilterForm_" + this.getClass().getName();
  }
