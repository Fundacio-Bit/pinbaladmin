 ...
 * @author GenApp
 */
@MenuOption(labelCode="grupEntitatCedent.grupEntitatCedent.plural", order=170, group=Tab.MENU_WEBDB)
@Controller
...
public class GrupEntitatCedentController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.GrupEntitatCedentService.JNDI_NAME)
  ...
  public String editarGrupEntitatCedentPost(@ModelAttribute GrupEntitatCedentForm grupEntitatCedentForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de GrupEntitatCedent
   */
  @RequestMapping(value = "/cancel")
  public String cancelGrupEntitatCedent(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "GrupEntitatCedent_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, GrupEntitatCedent grupEntitatCedent) throws I18NException {
