 ...
 */
@Controller
@RequestMapping(value = "/admin/documentcedent")
@SessionAttributes(types = { DocumentCedentForm.class, DocumentCedentFilterForm.class })
public class DocumentCedentAdminController extends DocumentCedentController {
    ...
    public String getTileForm() {
        return "documentCedentForm_admin";
    }

    @Override
    public String getTileList() {
        return "documentCedentList_admin";
    }

    @Override
    public String getSessionAttributeFilterForm() {
        return "DocumentCedentAdmin_FilterForm";
    }
    ...
    public DocumentCedentFilterForm getDocumentCedentFilterForm(Integer pagina, ModelAndView mav,
        ...
        if (documentCedentFilterForm.isNou()) {
            ...
            documentCedentFilterForm.addAdditionalButton(
                    new AdditionalButton(IconUtils.ICON_ARROW_LEFT, "tornar", "/admin/cedent/list", AdditionalButtonStyle.INFO));
        }
