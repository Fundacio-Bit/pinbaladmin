 ...
 *
 */
public class PinbalAdminSessionLocaleResolver extends SessionLocaleResolver{
	...
	protected Locale determineDefaultLocale(HttpServletRequest request) {
		...
		try {
			...
			if (idioma == null) {
            idioma = org.fundaciobit.pinbaladmin.commons.utils.Configuracio.getDefaultLanguage();
			}
