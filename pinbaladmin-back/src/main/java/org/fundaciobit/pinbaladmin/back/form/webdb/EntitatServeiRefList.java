 ...
 */
@Component
public class EntitatServeiRefList extends RefListBase implements EntitatServeiFields {

    @EJB(mappedName = EntitatServeiService.JNDI_NAME)
    private EntitatServeiService entitatServeiEjb;
