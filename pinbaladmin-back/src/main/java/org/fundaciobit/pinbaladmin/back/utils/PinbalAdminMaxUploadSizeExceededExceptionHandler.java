 ...
 * 
 */
public class PinbalAdminMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof PinbalAdminMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof PinbalAdminMaxUploadSizeExceededException) {
          msgCode = ((PinbalAdminMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
