...
import org.fundaciobit.pinbaladmin.persistence.validator.TraduccioValidator;
...
public class TraduccioWebValidator extends AbstractWebValidator<TraduccioForm, Traduccio>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.TraduccioService.JNDI_NAME)
