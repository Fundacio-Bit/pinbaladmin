 ...
 * @author GenApp
 */
@MenuOption(labelCode="servei.servei.plural", order=250, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/servei")
@SessionAttributes(types = { ServeiForm.class, ServeiFilterForm.class })
@Tile(name="serveiFormWebDB", contentJsp="/WEB-INF/jsp/webdb/serveiForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="servei.servei")})
@Tile(name="serveiListWebDB", contentJsp="/WEB-INF/jsp/webdb/serveiList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="servei.servei") })
public class ServeiController
  ...
  public Map<Field<?>, GroupByItem> fillReferencesForList(ServeiFilterForm filterForm,
    ...
    // Field estatServeiID
    {
      ...
      _tmp = Utils.listToMap(_listSKV);
      filterForm.setMapOfValuesForEstatServeiID(_tmp);
  ...
  public void exportList(@PathVariable("dataExporterID") String dataExporterID,
    ...
    __mapping.put(ESTATSERVEIID, filterForm.getMapOfValuesForEstatServeiID());
  ...
  public void fillReferencesForForm(ServeiForm serveiForm,
    ...
    // Comprovam si ja esta definida la llista
    if (serveiForm.getListOfValuesForEstatServeiID() == null) {
      List<StringKeyValue> _listSKV = getReferenceListForEstatServeiID(request, mav, serveiForm, null);

      if(_listSKV != null && !_listSKV.isEmpty()) { 
          java.util.Collections.sort(_listSKV, STRINGKEYVALUE_COMPARATOR);
      }
      serveiForm.setListOfValuesForEstatServeiID(_listSKV);
    }
    // Comprovam si ja esta definida la llista
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Servei
   */
  @RequestMapping(value = "/cancel")
  public String cancelServei(HttpServletRequest request,HttpServletResponse response) {
  ...
  public List<StringKeyValue> getReferenceListForEstatServeiID(HttpServletRequest request,
    ...
    return getReferenceListForEstatServeiID(request, mav, where);
  }
  ...
  public List<StringKeyValue> getReferenceListForEstatServeiID(HttpServletRequest request,
    ...
    if (serveiFilterForm.isHiddenField(ESTATSERVEIID)
       ...
       && !serveiFilterForm.isFilterByField(ESTATSERVEIID)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public List<StringKeyValue> getReferenceListForEstatServeiID(HttpServletRequest request,
    ...
    __tmp.add(new StringKeyValue("151200" , "151200"));
    __tmp.add(new StringKeyValue("151201" , "151201"));
    return __tmp;
  }
  ...
  public List<StringKeyValue> getReferenceListForTipusConsentiment(HttpServletRequest request,
    ...
    if (serveiFilterForm.isHiddenField(TIPUSCONSENTIMENT)
       ...
       && !serveiFilterForm.isFilterByField(TIPUSCONSENTIMENT)) {
      return EMPTY_STRINGKEYVALUE_LIST;
    }
    Where _w = null;
  ...
  public String getSessionAttributeFilterForm() {
    return "Servei_FilterForm_" + this.getClass().getName();
  }
