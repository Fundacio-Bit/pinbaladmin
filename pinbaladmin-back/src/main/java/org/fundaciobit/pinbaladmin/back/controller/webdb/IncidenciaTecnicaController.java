...
public class IncidenciaTecnicaController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.IncidenciaTecnicaService.JNDI_NAME)
  ...
  public String editarIncidenciaTecnicaPost(@ModelAttribute IncidenciaTecnicaForm incidenciaTecnicaForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de IncidenciaTecnica
   */
  @RequestMapping(value = "/cancel")
  public String cancelIncidenciaTecnica(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "IncidenciaTecnica_FilterForm_" + this.getClass().getName();
  }
