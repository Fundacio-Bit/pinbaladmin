 ...
 */
@Controller
@RequestMapping(value = "/admin/documententitatlocal")
@SessionAttributes(types = { DocumentCedentForm.class, DocumentCedentFilterForm.class })
public class DocumentEntitatLocalAdminController extends DocumentEntitatController {
    ...
    public String getTileForm() {
        return "documentEntitatForm_admin";
    }

    @Override
    public String getTileList() {
        return "documentEntitatList_admin";
    }

    @Override
    public String getSessionAttributeFilterForm() {
        return "DocumentEntitatLocalAdmin_FilterForm";
    }
    ...
    public DocumentEntitatFilterForm getDocumentEntitatFilterForm(Integer pagina, ModelAndView mav,
        ...
        if (documentCedentFilterForm.isNou()) {
            ...
            documentCedentFilterForm.addAdditionalButton(
                    new AdditionalButton(IconUtils.ICON_ARROW_LEFT, "tornar", "/admin/entitat/list", AdditionalButtonStyle.INFO));
        }
