 ...
 */
@Component
public class TramitECteAudFilterForm extends PinbalAdminBaseFilterForm implements TramitECteAudFields {

  private java.lang.Long cteaudidDesde;

  public java.lang.Long getCteaudidDesde() {
    return this.cteaudidDesde;
  }

  public void setCteaudidDesde(java.lang.Long cteaudidDesde) {
    this.cteaudidDesde = cteaudidDesde;
  }


  private java.lang.Long cteaudidFins;

  public java.lang.Long getCteaudidFins() {
    return this.cteaudidFins;
  }

  public void setCteaudidFins(java.lang.Long cteaudidFins) {
    this.cteaudidFins = cteaudidFins;
  }
  ...
  public TramitECteAudFilterForm() {
  }
  
  public TramitECteAudFilterForm(TramitECteAudFilterForm __toClone) {
    super(__toClone);
    this.cteaudidDesde = __toClone.cteaudidDesde;
    this.cteaudidFins = __toClone.cteaudidFins;
