 ...
 */
@Controller
@RequestMapping(value = "/admin/correucedents")
@SessionAttributes(types = { EventForm.class, EventFilterForm.class })
public class CorreusCedentsAdminController {

    protected static final Logger log = Logger.getLogger(CorreusCedentsAdminController.class);
    ...
    public ModelAndView listPost(HttpServletRequest request, HttpServletResponse response) throws I18NException {
		...
		log.info("Entra a infocorreuscedents_admin");

		ModelAndView mav = new ModelAndView("infocorreuscedents_admin");
