...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de DocumentCedent
   */
  @RequestMapping(value = "/cancel")
  public String cancelDocumentCedent(HttpServletRequest request,HttpServletResponse response) {
