 ...
 * @author GenApp
 */
@MenuOption(labelCode="documentEntitat.documentEntitat.plural", order=60, group=Tab.MENU_WEBDB)
@Controller
...
public class DocumentEntitatController
  ...
  public String editarDocumentEntitatPost(@ModelAttribute DocumentEntitatForm documentEntitatForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de DocumentEntitat
   */
  @RequestMapping(value = "/cancel")
  public String cancelDocumentEntitat(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "DocumentEntitat_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, DocumentEntitat documentEntitat) throws I18NException {
