...
import org.fundaciobit.pinbaladmin.persistence.validator.FitxerValidator;
...
public class FitxerWebValidator extends AbstractWebValidator<FitxerForm, Fitxer>
  ...
  // EJB's
  @javax.ejb.EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.FitxerService.JNDI_NAME)
