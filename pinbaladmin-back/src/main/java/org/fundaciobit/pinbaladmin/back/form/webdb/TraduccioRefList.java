...
import org.fundaciobit.pinbaladmin.ejb.TraduccioService;
...
public class TraduccioRefList extends RefListBase
  ...
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    ...
    for (org.fundaciobit.pinbaladmin.model.entity.Traduccio traduccio : traduccions) {
      org.fundaciobit.pinbaladmin.persistence.TraduccioJPA traduccioJPA = (org.fundaciobit.pinbaladmin.persistence.TraduccioJPA) traduccio;
      String key = String.valueOf(traduccioJPA.getTraduccioID());
      org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA _tm = traduccioJPA.getTraduccio(_lang);
      String value;
      if (_tm == null) {
