 ...
 * @author GenApp
 */
@MenuOption(labelCode="tipusTiquet.tipusTiquet.plural", order=260, group=Tab.MENU_WEBDB)
@Controller
...
public class TipusTiquetController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.TipusTiquetService.JNDI_NAME)
  ...
  public String editarTipusTiquetPost(@ModelAttribute TipusTiquetForm tipusTiquetForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de TipusTiquet
   */
  @RequestMapping(value = "/cancel")
  public String cancelTipusTiquet(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getSessionAttributeFilterForm() {
    return "TipusTiquet_FilterForm_" + this.getClass().getName();
  }
  ...
  public void delete(HttpServletRequest request, TipusTiquet tipusTiquet) throws I18NException {
