...
import org.fundaciobit.pinbaladmin.back.validator.webdb.FitxerWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="fitxer.fitxer.plural", order=130, group=Tab.MENU_WEBDB)
@Controller
...
public class FitxerController
    extends org.fundaciobit.pinbaladmin.back.controller.PinbalAdminBaseController<Fitxer, java.lang.Long> implements FitxerFields {
