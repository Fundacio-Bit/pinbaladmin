...
public class TilesFactoryApp implements DefinitionsFactory {
    ...
    static {
        ...
        String packageToScan = Constants.PINBALADMIN_PROPERTY_BASE + "back.controller";
        {
    ...
    private static Map<String, Definition> getAppDefinitions() {
        ...
        /*{name=base.cap, template=/WEB-INF/jsp/moduls/cap.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.CapPreparer, attributes=null}*/
        Definition def_base_cap = new Definition("base.cap", new Attribute("/WEB-INF/jsp/moduls/cap.jsp"),
                new HashMap<String, Attribute>());
        def_base_cap.setPreparer("org.fundaciobit.pinbaladmin.back.preparer.CapPreparer");
        ...
        /*{name=base.menu, template=/WEB-INF/jsp/moduls/blanc.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.MenuPreparer, attributes=null}*/
        Definition def_base_menu = new Definition("base.menu", new Attribute("/WEB-INF/jsp/moduls/blanc.jsp"),
                new HashMap<String, Attribute>());
        def_base_menu.setPreparer("org.fundaciobit.pinbaladmin.back.preparer.MenuPreparer");
        ...
        /*{name=base.peu, template=/WEB-INF/jsp/moduls/peu.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.PeuPreparer, attributes=null}*/
        Definition def_base_peu = new Definition("base.peu", new Attribute("/WEB-INF/jsp/moduls/peu.jsp"),
                new HashMap<String, Attribute>());
        def_base_peu.setPreparer("org.fundaciobit.pinbaladmin.back.preparer.PeuPreparer");
        map.put("base.peu", def_base_peu);
        /* ================================== */

        /*{name=base.definition, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, cap=base.cap, contingut=base.contingut, menu=base.menu}}*/
        ...
        def_base_definition.setPreparer("org.fundaciobit.pinbaladmin.back.preparer.BasePreparer");
        ...
        /*{name=sense_enllaz, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, enlaces=, cap=base.cap, contingut=base.contingut, menu=base.menu}}*/
        ...
        def_sense_enllaz.setPreparer("org.fundaciobit.pinbaladmin.back.preparer.BasePreparer");
        ...
        /*{name=exceptionTile, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, contingut=/error.jsp, cap=base.cap, menu=base.menu}}*/
        ...
        def_exceptionTile.setPreparer("org.fundaciobit.pinbaladmin.back.preparer.BasePreparer");
        ...
        /*{name=all, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, contingut=/WEB-INF/jsp/all/homepublic.jsp, cap=base.cap, menu=/WEB-INF/jsp/moduls/menu_inici.jsp}}*/
        ...
        /*{name=avislegal_ca, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, contingut=/WEB-INF/jsp/all/avislegal_ca.jsp, cap=base.cap, menu=/WEB-INF/jsp/moduls/menu_inici.jsp}}*/
        ...
        /*{name=avislegal_es, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, contingut=/WEB-INF/jsp/all/avislegal_es.jsp, cap=base.cap, menu=/WEB-INF/jsp/moduls/menu_inici.jsp}}*/
        ...
        /*{name=homepublic, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, contingut=/WEB-INF/jsp/all/homepublic.jsp, cap=base.cap, menu=/WEB-INF/jsp/moduls/menu_inici.jsp}}*/
        ...
        /*{name=common, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, contingut=/WEB-INF/jsp/principal.jsp, cap=base.cap, menu=/WEB-INF/jsp/moduls/menu_inici.jsp}}*/
        ...
        /*{name=principal, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, contingut=/WEB-INF/jsp/principal.jsp, cap=base.cap, menu=/WEB-INF/jsp/moduls/menu_inici.jsp}}*/
        ...
        /*{name=user, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, pipella=user, cap=base.cap, contingut=base.contingut, menu=/WEB-INF/jsp/moduls/menu_user.jsp}}*/
        ...
        /*{name=admin, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, pipella=admin, cap=base.cap, contingut=base.contingut, menu=/WEB-INF/jsp/moduls/menu_admin.jsp}}*/
        ...
        /*{name=desenvolupament, template=/WEB-INF/jsp/layout/layout.jsp, role=null, preparerInstance=org.fundaciobit.pinbaladmin.back.preparer.BasePreparer, attributes={menu_i_contingut=base.menu_i_contingut, peu=base.peu, pipella=desenvolupament, contingut=/WEB-INF/jsp/desenvolupament.jsp, cap=base.cap, menu=/WEB-INF/jsp/moduls/menu_desenvolupament.jsp}}*/
