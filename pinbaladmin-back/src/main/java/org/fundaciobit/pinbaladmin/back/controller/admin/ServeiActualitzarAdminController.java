 ...
 */
@Controller
public class ServeiActualitzarAdminController {
    ...
    @RequestMapping(value = "/admin/actualitzarserveis", method = RequestMethod.GET)
    public ModelAndView actualitzarServeisGet(HttpServletRequest request, HttpServletResponse response)
            throws I18NException {

        return new ModelAndView("actualitzarserveis_admin");

    }

    @RequestMapping(value = "/admin/actualitzarserveis", method = RequestMethod.POST)
    public String actualitzarServeisPost(HttpServletRequest request, HttpServletResponse response)
            throws I18NException {
        ...
        CsvToBean<NouServei> cb = new CsvToBeanBuilder<NouServei>(reader).withType(NouServei.class).withSeparator('\t')
        ...
        for (NouServei nouServei : serveisList) {
            ...
            if (id != null) {
                ...
                if (serveiID == null) {
                    ...
                    Long form = null;
                    serveiEjb.create(nouServei.getCodi(), nouServei.getNom(), nouServei.getDescripcio(), form, id,
                            20L /* produccio */ , tipusConsentiment, false);
