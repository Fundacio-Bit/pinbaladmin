...
public class PinfoDataPublicController extends PinfoDataController {
        ...
        try {
            ...
            if (usuarisList.size() == 0) {
                ...
                if (usuarisList != null && usuarisList.size() == 0) {
                    ...
                    log.info("getUsuarisParam() Ha filtrat " + usuarisList.size() + " usuaris amb dada parcial[" + entrada + "]");
                    /*
            ...
            log.error("Error al obtenir usuaris per dada parcial[" + entrada + "]: " + e.getMessage(), e);
            return null;
        }
    }
    ...
    public void obtenirJsonProcediments(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        for (Item soli : solisCache) {
            ...
            if (param == null || param.isEmpty() || soli.getKey().toLowerCase().contains(param.toLowerCase())
    ...
    // }
    //
    public void afegirResponsableAmbUsername(String username, String carrec, List<Responsable> responsablesList,
