 ...
 * @author GenApp
 */
@MenuOption(labelCode="campSolicitud.campSolicitud.plural", order=20, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de CampSolicitud
   */
  @RequestMapping(value = "/cancel")
  public String cancelCampSolicitud(HttpServletRequest request,HttpServletResponse response) {
