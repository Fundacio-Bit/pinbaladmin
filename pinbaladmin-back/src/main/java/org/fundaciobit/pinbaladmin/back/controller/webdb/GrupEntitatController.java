...
import org.fundaciobit.pinbaladmin.back.form.webdb.GrupEntitatForm;

import org.fundaciobit.pinbaladmin.back.validator.webdb.GrupEntitatWebValidator;
 ...
 * @author GenApp
 */
@MenuOption(labelCode="grupEntitat.grupEntitat.plural", order=150, group=Tab.MENU_WEBDB)
@Controller
...
public class GrupEntitatController
    extends org.fundaciobit.pinbaladmin.back.controller.PinbalAdminBaseController<GrupEntitat, java.lang.Long> implements GrupEntitatFields {

  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.GrupEntitatService.JNDI_NAME)
