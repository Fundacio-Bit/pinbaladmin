 ...
 * @author anadal
 */
public class DocumentSolicitudValidator<I extends DocumentSolicitud>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements DocumentSolicitudFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(DOCUMENTID) == 0) {
      java.lang.Long __documentid = __target__.getDocumentID();
      Long __count_ = null;
