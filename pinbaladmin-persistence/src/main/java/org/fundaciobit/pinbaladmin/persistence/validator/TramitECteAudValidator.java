 ...
 * @author anadal
 */
public class TramitECteAudValidator<I extends TramitECteAud>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements TramitECteAudFields {

    protected final Logger log = Logger.getLogger(getClass());


  public TramitECteAudValidator() {
    super();    
  }
