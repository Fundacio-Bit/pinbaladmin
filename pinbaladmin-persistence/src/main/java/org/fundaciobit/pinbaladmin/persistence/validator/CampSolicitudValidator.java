 ...
 * @author anadal
 */
public class CampSolicitudValidator<I extends CampSolicitud>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements CampSolicitudFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(CAMPFORMULARIID) == 0) {
      java.lang.Long __campformulariid = __target__.getCampFormulariID();
      Long __count_ = null;
    ...
    if (__vr.getFieldErrorCount(SOLICITUDSERVEIID) == 0) {
      java.lang.Long __solicitudserveiid = __target__.getSolicitudServeiID();
      Long __count_ = null;
