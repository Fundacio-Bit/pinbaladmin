...
@Entity(name = "DocumentEntitatJPA")
@Table(name = "pad_documententitat" , indexes = { 
        @Index(name="pad_documententitat_pk_i", columnList = "documententitatid"),
        @Index(name="pad_docent_entitat_fk_i", columnList = "entitatid"),
        @Index(name="pad_docent_fitxerid_fk_i", columnList = "fitxerid")})
@SequenceGenerator(name="DOCUMENTENTITAT_SEQ", sequenceName="pad_documententitat_seq", allocationSize=1, initialValue=1000)
@javax.xml.bind.annotation.XmlRootElement
public class DocumentEntitatJPA implements DocumentEntitat {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="DOCUMENTENTITAT_SEQ")
...
// IMP Field:entitatid | Table: pad_entitat | Type: 1  
    ...
    @JoinColumn(name = "entitatid", referencedColumnName ="entitatID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_docent_entitat_fk"))
...
// IMP Field:fitxerid | Table: pad_fitxer | Type: 1  
    ...
    @JoinColumn(name = "fitxerid", referencedColumnName ="fitxerID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_docent_fitxer_fitxe_fk"))
