...
@Entity(name = "TiquetJPA")
@Table(name = "pad_tiquet" , indexes = { 
        @Index(name="pad_tiquet_pk_i", columnList = "tiquetid"),
        @Index(name="pad_tiquet_estattiquetid_fk_i", columnList = "estattiquetid"),
        @Index(name="pad_tiquet_tipustiquetid_fk_i", columnList = "tipustiquetid"),
        @Index(name="pad_tiquet_adjunt1id_fk_i", columnList = "adjunt1id"),
        @Index(name="pad_tiquet_adjunt2id_fk_i", columnList = "adjunt2id")})
@SequenceGenerator(name="TIQUET_SEQ", sequenceName="pad_tiquet_seq", allocationSize=1, initialValue=1000)
@javax.xml.bind.annotation.XmlRootElement
public class TiquetJPA implements Tiquet {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="TIQUET_SEQ")
...
// IMP Field:estattiquetid | Table: pad_estattiquet | Type: 1  
    ...
    @JoinColumn(name = "estattiquetid", referencedColumnName ="estatTiquetID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_tiquet_estattique_estat_fk"))
...
// IMP Field:tipustiquetid | Table: pad_tipustiquet | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "tipustiquetid", referencedColumnName ="tipusTiquetID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_tiquet_tiptiquet_fk"))
...
// IMP Field:fitxerid | Table: pad_fitxer | Type: 1  
    ...
    @JoinColumn(name = "adjunt1id", referencedColumnName ="fitxerID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_tiquet_fitxer_adj1_fk"))
...
// IMP Field:fitxerid | Table: pad_fitxer | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "adjunt2id", referencedColumnName ="fitxerID", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_tiquet_fitxer_adj2_fk"))
