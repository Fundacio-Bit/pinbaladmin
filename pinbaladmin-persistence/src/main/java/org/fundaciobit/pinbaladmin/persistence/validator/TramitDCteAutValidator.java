 ...
 * @author anadal
 */
public class TramitDCteAutValidator<I extends TramitDCteAut>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements TramitDCteAutFields {

    protected final Logger log = Logger.getLogger(getClass());


  public TramitDCteAutValidator() {
    super();    
  }
