...
@Table(name = "pad_grupentitat" , indexes = { 
        @Index(name="pad_grupentitat_pk_i", columnList = "grupentitatid")})
@SequenceGenerator(name="GRUPENTITAT_SEQ", sequenceName="pad_grupentitat_seq", allocationSize=1, initialValue=1000)
