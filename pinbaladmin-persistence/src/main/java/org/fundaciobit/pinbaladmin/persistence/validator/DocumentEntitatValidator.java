 ...
 * @author anadal
 */
public class DocumentEntitatValidator<I extends DocumentEntitat>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements DocumentEntitatFields {

    protected final Logger log = Logger.getLogger(getClass());


  public DocumentEntitatValidator() {
    super();    
  }
