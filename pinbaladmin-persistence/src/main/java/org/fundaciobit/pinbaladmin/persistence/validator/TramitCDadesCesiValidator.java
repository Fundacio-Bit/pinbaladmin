...
public class TramitCDadesCesiValidator<I extends TramitCDadesCesi>
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    __vr.rejectIfEmptyOrWhitespace(__target__,ORGANID, 
        "genapp.validation.required",
        new org.fundaciobit.genapp.common.i18n.I18NArgumentCode(get(ORGANID)));

    __vr.rejectIfEmptyOrWhitespace(__target__,ORGANARRELID, 
        "genapp.validation.required",
        new org.fundaciobit.genapp.common.i18n.I18NArgumentCode(get(ORGANARRELID)));
