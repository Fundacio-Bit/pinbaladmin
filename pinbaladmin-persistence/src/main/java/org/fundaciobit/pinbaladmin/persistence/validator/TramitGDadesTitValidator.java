 ...
 * @author anadal
 */
public class TramitGDadesTitValidator<I extends TramitGDadesTit>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements TramitGDadesTitFields {

    protected final Logger log = Logger.getLogger(getClass());


  public TramitGDadesTitValidator() {
    super();    
  }
