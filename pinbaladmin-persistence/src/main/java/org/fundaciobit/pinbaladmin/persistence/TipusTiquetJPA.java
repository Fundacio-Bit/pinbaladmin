...
@Entity(name = "TipusTiquetJPA")
@Table(name = "pad_tipustiquet" , indexes = { 
        @Index(name="pad_tipustiquet_pk_i", columnList = "tipustiquetid")})
@SequenceGenerator(name="TIPUSTIQUET_SEQ", sequenceName="pad_tipustiquet_seq", allocationSize=1, initialValue=1000)
