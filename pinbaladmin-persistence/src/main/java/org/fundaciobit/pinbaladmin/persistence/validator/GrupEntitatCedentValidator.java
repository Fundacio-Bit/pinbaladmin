 ...
 * @author anadal
 */
public class GrupEntitatCedentValidator<I extends GrupEntitatCedent>
    extends org.fundaciobit.genapp.common.validation.AbstractValidator    implements GrupEntitatCedentFields {
  ...
  public void validate(IValidatorResult<I> __vr,I __target__, boolean __isNou__
    ...
    if (__isNou__) { // Creació
      ...
      if (__vr.getFieldErrorCount(GRUPENTITATID) == 0 && __vr.getFieldErrorCount(CEDENTID) == 0) {
        ...
        java.lang.Long __cedentid = __target__.getCedentID();
        Long __count_ = null;
      ...
      if (__vr.getFieldErrorCount(GRUPENTITATID) == 0 && __vr.getFieldErrorCount(CEDENTID) == 0 && __vr.getFieldErrorCount(GRUPENTITATCEDENTID) == 0) {
        java.lang.Long __grupentitatid = __target__.getGrupEntitatID();
        java.lang.Long __cedentid = __target__.getCedentID();
        java.lang.Long __grupentitatcedentid = __target__.getGrupEntitatCedentID();
        Long __count_ = null;
