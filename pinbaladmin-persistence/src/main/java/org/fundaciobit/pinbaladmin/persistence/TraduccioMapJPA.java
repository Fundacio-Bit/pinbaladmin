...
@Table(name = "pad_traducciomap" , indexes = { 
        @Index(name="pad_traducciomap_pk_i", columnList = "traducciomapid"),
        @Index(name="pad_traducciomap_idiomaid_fk_i", columnList = "idiomaid")})
