...
@Table(name = "pad_traduccio" , indexes = { 
        @Index(name="pad_traduccio_pk_i", columnList = "traduccioid")})
@SequenceGenerator(name="TRADUCCIO_SEQ", sequenceName="pad_traduccio_seq", allocationSize=1, initialValue=1000)
...
public class TraduccioJPA implements Traduccio {
  ...
  @ElementCollection(fetch= FetchType.EAGER, targetClass = org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="pad_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")}, foreignKey=@ForeignKey(name="pad_traducmap_traduccio_fk"))
  @javax.persistence.MapKeyColumn(name="idiomaid")
  private Map<String, org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA> traduccions =  new HashMap<String, org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA>();

  public Map<String, org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA> _traduccions_) {
  ...
  public org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA getTraduccio(String idioma) {
    return (org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, org.fundaciobit.pinbaladmin.persistence.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
