...
@Entity(name = "ServeiJPA")
@Table(name = "pad_servei" , indexes = { 
        @Index(name="pad_servei_pk_i", columnList = "serveiid"),
        @Index(name="pad_servei_formulariid_fk_i", columnList = "formulariid"),
        @Index(name="pad_servei_entservid_fk_i", columnList = "entitatserveiid"),
        @Index(name="pad_servei_estatserveiid_fk_i", columnList = "estatserveiid")})
@SequenceGenerator(name="SERVEI_SEQ", sequenceName="pad_servei_seq", allocationSize=1, initialValue=1000)
@javax.xml.bind.annotation.XmlRootElement
public class ServeiJPA implements Servei {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="SERVEI_SEQ")
...
// IMP Field:formulariid | Table: pad_formulari | Type: 1  
    ...
    @JoinColumn(name = "formulariid", referencedColumnName ="formulariid", nullable = true, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_servei_formulari_fk"))
...
// IMP Field:entitatserveiid | Table: pad_entitatservei | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "entitatserveiid", referencedColumnName ="entitatServeiID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_servei_entiservei_fk"))
...
// IMP Field:estatserveiid | Table: pad_estatservei | Type: 1  
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "estatserveiid", referencedColumnName ="estatServeiID", nullable = false, insertable=false, updatable=false, foreignKey=@ForeignKey(name="pad_servei_estatserv_fk"))
