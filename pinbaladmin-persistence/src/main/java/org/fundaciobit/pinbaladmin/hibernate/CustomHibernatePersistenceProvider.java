package org.fundaciobit.pinbaladmin.hibernate;
		...
		if(fitxerProperties != null) {
			fitxerProperties.forEach((k,v) -> {
               String kStr = k.toString();
	        	if (kStr.startsWith("org.fundaciobit.pinbaladmin.hibernate")) {
	        		projecteProperties.put(kStr.replace("org.fundaciobit.pinbaladmin.",""), v.toString());
