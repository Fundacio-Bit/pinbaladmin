...
public class GrupEntitatBean implements GrupEntitat {
  ...
  public GrupEntitatBean(long grupEntitatID , java.lang.String nom , java.lang.String descripcio) {
    this.grupEntitatID=grupEntitatID;
    this.nom=nom;
    this.descripcio=descripcio;
}
  /** Constructor sense valors autoincrementals */
  public GrupEntitatBean(java.lang.String nom , java.lang.String descripcio) {
    this.nom=nom;
    this.descripcio=descripcio;
}
