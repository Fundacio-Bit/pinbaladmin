...
public interface TramitECteAudFields extends java.io.Serializable {

  public static final String _TABLE_SQL = "pad_tramit_e_cte_aud";


  public static final String _TABLE_MODEL = "tramitECteAud";


  public static final String _TABLE_TRANSLATION = _TABLE_MODEL + "." + _TABLE_MODEL;


	 public static final LongField CTEAUDID = new LongField(_TABLE_MODEL, "cteaudid", "cteaudid");  // PK
  ...
  public static final Field<?>[] ALL_TRAMITECTEAUD_FIELDS = {
    CTEAUDID,
    TRAMITID,
    NIF,
    NOM,
