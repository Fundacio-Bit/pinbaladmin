...
public class FitxerValidator<T> implements FitxerFields {
  ...
  public void validate(IValidatorResult<T> __vr, T __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(MIME) == 0) {
      ...
      if (__mime!= null && __mime.length() > 100) {
        __vr.rejectValue(MIME, "genapp.validation.sizeexceeds",
            new org.fundaciobit.genapp.common.i18n.I18NArgumentCode(get(MIME)), new org.fundaciobit.genapp.common.i18n.I18NArgumentString(String.valueOf(100)));
      }
    }
