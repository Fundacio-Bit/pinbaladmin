...
public class TraduccioBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.pinbaladmin.model.dao.ITraduccioManager __traduccioManager;


  public final TraduccioValidator<TraduccioJPA> _validator;


  public TraduccioBeanValidator(org.fundaciobit.pinbaladmin.model.dao.ITraduccioManager __traduccioManager) { 
  ...
  public TraduccioBeanValidator(TraduccioValidator<TraduccioJPA> _validator,
     org.fundaciobit.pinbaladmin.model.dao.ITraduccioManager __traduccioManager) {
    this.__traduccioManager = __traduccioManager;
