...
private static final long serialVersionUID = -1639067977L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="PINBALADMIN_SEQ")
	@Index(name="pad_documentcedent_pk_i")
  ...
  @Lob
	...
	@Index(name="pad_doccedent_entservei_fk_i")
	...
	@Index(name="pad_doccedent_fitxerid_fk_i")
...
// IMP Field:entitatserveiid | Table: pad_entitatservei | Type: 1  
	...
	@ForeignKey(name="pad_doccedent_entiservei_fk")
...
// IMP Field:fitxerid | Table: pad_fitxer | Type: 1  
	...
	@ForeignKey(name="pad_doccedent_fitxer_fitxe_fk")
