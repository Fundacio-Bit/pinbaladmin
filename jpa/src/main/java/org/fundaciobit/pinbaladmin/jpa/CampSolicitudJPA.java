...
// IMP Field:campformulariid | Table: pad_campformulari | Type: 1  
	...
	@ForeignKey(name="pad_campsoli_campform_fk")
	@JoinColumn(name = "campformulariid", referencedColumnName ="campFormulariID", nullable = false, insertable=false, updatable=false)
...
// IMP Field:id | Table: pad_solicitudservei | Type: 1  
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@ForeignKey(name="pad_campsoli_soliservei_fk")
	@JoinColumn(name = "solicitudserveiid", referencedColumnName ="id", nullable = false, insertable=false, updatable=false)
