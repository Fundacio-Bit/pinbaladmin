...
public class SolicitudServeiBeanValidator 
  ...
  public SolicitudServeiBeanValidator(org.fundaciobit.pinbaladmin.model.dao.IEstatSolicitudServeiManager __estatSolicitudServeiManager,
  ...
  public List<I18NFieldError> validate(SolicitudServeiJPA target, boolean isNou) throws I18NException {
    ...
    _validator.validate(_bvr_, target, isNou, __estatSolicitudServeiManager, __serveiManager, __solicitudManager, __solicitudServeiManager);
