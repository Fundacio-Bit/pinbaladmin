 ...
 * @author anadal
 */
public class TiquetValidator<T> implements TiquetFields {
  ...
  public void validate(IValidatorResult<T> __vr, T __target__, boolean __isNou__
    ...
    if (__vr.getFieldErrorCount(INFORMADOR) == 0) {
      java.lang.String __informador = (java.lang.String)__vr.getFieldValue(__target__,INFORMADOR);
    ...
    if (__vr.getFieldErrorCount(VERSIOPINBAL) == 0) {
      java.lang.String __versiopinbal = (java.lang.String)__vr.getFieldValue(__target__,VERSIOPINBAL);
    ...
    if (__vr.getFieldErrorCount(SOLUCIONATPER) == 0) {
      java.lang.String __solucionatper = (java.lang.String)__vr.getFieldValue(__target__,SOLUCIONATPER);
    ...
    if (__vr.getFieldErrorCount(ESTATTIQUETID) == 0) {
      java.lang.Long __estattiquetid = (java.lang.Long)__vr.getFieldValue(__target__,ESTATTIQUETID);
      Long __count_ = null;
