...
public class IdiomaBeanValidator 
  ...
  // EJB's
  protected final org.fundaciobit.pinbaladmin.model.dao.IIdiomaManager __idiomaManager;


  public final IdiomaValidator<IdiomaJPA> _validator;


  public IdiomaBeanValidator(org.fundaciobit.pinbaladmin.model.dao.IIdiomaManager __idiomaManager) { 
  ...
  public IdiomaBeanValidator(IdiomaValidator<IdiomaJPA> _validator,
     org.fundaciobit.pinbaladmin.model.dao.IIdiomaManager __idiomaManager) {
    this.__idiomaManager = __idiomaManager;
