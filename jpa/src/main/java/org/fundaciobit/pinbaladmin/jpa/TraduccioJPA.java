...
private static final long serialVersionUID = -326205279L;
  ...
  @CollectionOfElements(fetch= FetchType.EAGER,targetElement = org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA.class)
  @Cascade(value=org.hibernate.annotations.CascadeType.ALL)
  @LazyCollection(value= LazyCollectionOption.FALSE)
  @JoinTable(name="pad_traducciomap",joinColumns={@JoinColumn(name="traducciomapid")})
  @org.hibernate.annotations.MapKey(columns={@Column(name="idiomaid")})
  @ForeignKey(name="pad_traducmap_traduccio_fk") 
  private Map<String, org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA> traduccions =  new HashMap<String, org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA>();

  public Map<String, org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA> getTraduccions() {
    return this.traduccions;
  }

  public void setTraduccions(Map<String, org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA> _traduccions_) {
  ...
  public org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA getTraduccio(String idioma) {
    return (org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA) traduccions.get(idioma);
  }
  
  public void addTraduccio(String idioma, org.fundaciobit.pinbaladmin.jpa.TraduccioMapJPA traduccio) {
    if (traduccio == null) {
