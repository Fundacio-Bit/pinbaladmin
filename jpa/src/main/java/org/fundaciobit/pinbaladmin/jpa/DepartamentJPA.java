...
private static final long serialVersionUID = 1839760944L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="PINBALADMIN_SEQ")
	@Index(name="pad_depart_pk_i")
	...
	@Index(name="pad_departament_areaid_fk_i")
...
// IMP Field:areaid | Table: pad_area | Type: 1  
	...
	@ForeignKey(name="pad_depart_area_fk")
