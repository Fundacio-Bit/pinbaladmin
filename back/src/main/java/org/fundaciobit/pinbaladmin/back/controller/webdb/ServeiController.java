...
public class ServeiController
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarServeiPost(@ModelAttribute @Valid ServeiForm serveiForm,
    ...
    try {
      preValidate(request, serveiForm, result);
      getWebValidator().validate(servei, result);
      postValidate(request, serveiForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, Servei servei) throws Exception,I18NException {
