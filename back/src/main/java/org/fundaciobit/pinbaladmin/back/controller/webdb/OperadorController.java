...
public class OperadorController
  ...
  public String editarOperadorPost(@ModelAttribute @Valid OperadorForm operadorForm,
    ...
    try {
      preValidate(request, operadorForm, result);
      getWebValidator().validate(operador, result);
      postValidate(request, operadorForm, result);
  ...
  public String eliminarOperador(@PathVariable("operadorID") java.lang.Long operadorID,
    ...
    try {
      Operador operador = findByPrimaryKey(request, operadorID);
      if (operador == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, Operador operador) throws Exception,I18NException {
