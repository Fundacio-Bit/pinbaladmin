...
public class EventController
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarEventPost(@ModelAttribute @Valid EventForm eventForm,
    ...
    try {
      this.setFilesFormToEntity(afm, event, eventForm); // FILE
      preValidate(request, eventForm, result);
      getWebValidator().validate(event, result);
      postValidate(request, eventForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, Event event) throws Exception,I18NException {
