...
public class SolicitudDocumentOperadorController
    extends DocumentController {
  
  
  @EJB(mappedName = DocumentSolicitudLogicaLocal.JNDI_NAME)
  protected DocumentSolicitudLogicaLocal documentSolicitudLogicaEjb;
  ...
  public DocumentFilterForm getDocumentFilterForm(Integer pagina, ModelAndView mav,
    ...
    if (soli == null) {
      ...
      HtmlUtils.saveMessageError(request,
          "No puc trobar documents de la solicitud ja que no s'ha passat "
      ...
      // TODO Traduir
      documentFilterForm.setSubTitleCode("=Documents de la Solicitud amb Codi de Procediment "
          + codi.get(0));
  ...
  @Override
  public void delete(HttpServletRequest request, Document document) throws Exception,I18NException {
  ...
  public Where getAdditionalCondition(HttpServletRequest request) throws I18NException {
    ...
    List<Long> documentIDs =  documentSolicitudLogicaEjb.executeQuery(
        DocumentSolicitudFields.DOCUMENTID, DocumentSolicitudFields.SOLICITUDID.equal(soli));
