...
public class DocumentSolicitudController
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarDocumentSolicitudPost(@ModelAttribute @Valid DocumentSolicitudForm documentSolicitudForm,
    ...
    try {
      preValidate(request, documentSolicitudForm, result);
      getWebValidator().validate(documentSolicitud, result);
      postValidate(request, documentSolicitudForm, result);
  ...
  public String eliminarDocumentSolicitud(@PathVariable("documentSolicitudID") java.lang.Long documentSolicitudID,
    ...
    try {
      DocumentSolicitud documentSolicitud = findByPrimaryKey(request, documentSolicitudID);
      if (documentSolicitud == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, DocumentSolicitud documentSolicitud) throws Exception,I18NException {
