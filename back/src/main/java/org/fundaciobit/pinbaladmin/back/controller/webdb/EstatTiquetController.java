...
public class EstatTiquetController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.EstatTiquetLocal.JNDI_NAME)
  ...
  public String editarEstatTiquetPost(@ModelAttribute @Valid EstatTiquetForm estatTiquetForm,
    ...
    try {
      preValidate(request, estatTiquetForm, result);
      getWebValidator().validate(estatTiquet, result);
      postValidate(request, estatTiquetForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, EstatTiquet estatTiquet) throws Exception,I18NException {
