...
public class AreaController
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarAreaPost(@ModelAttribute @Valid AreaForm areaForm,
    ...
    try {
      preValidate(request, areaForm, result);
      getWebValidator().validate(area, result);
      postValidate(request, areaForm, result);
  ...
  public String eliminarArea(@PathVariable("areaID") java.lang.Long areaID,
    ...
    try {
      Area area = findByPrimaryKey(request, areaID);
      if (area == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, Area area) throws Exception,I18NException {
    areaEjb.delete(area);
  }
