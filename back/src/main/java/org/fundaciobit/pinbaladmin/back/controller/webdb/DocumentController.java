...
public class DocumentController
  ...
  public String editarDocumentPost(@ModelAttribute @Valid DocumentForm documentForm,
    ...
    try {
      this.setFilesFormToEntity(afm, document, documentForm); // FILE
      preValidate(request, documentForm, result);
      getWebValidator().validate(document, result);
      postValidate(request, documentForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String getSessionAttributeFilterForm() {
    return "DocumentWebDB_FilterForm";
  }
