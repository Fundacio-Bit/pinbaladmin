...
import org.fundaciobit.pinbaladmin.ejb.GrupEntitatCedentLocal;
...
public class GrupEntitatCedentRefList extends RefListBase
  ...
  @EJB(mappedName = GrupEntitatCedentLocal.JNDI_NAME)
  private GrupEntitatCedentLocal grupEntitatCedentEjb;
