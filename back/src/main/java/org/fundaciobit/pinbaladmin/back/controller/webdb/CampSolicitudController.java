...
public class CampSolicitudController
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarCampSolicitudPost(@ModelAttribute @Valid CampSolicitudForm campSolicitudForm,
    ...
    try {
      preValidate(request, campSolicitudForm, result);
      getWebValidator().validate(campSolicitud, result);
      postValidate(request, campSolicitudForm, result);
  ...
  public String eliminarCampSolicitud(@PathVariable("campSolicitudID") java.lang.Long campSolicitudID,
    ...
    try {
      CampSolicitud campSolicitud = findByPrimaryKey(request, campSolicitudID);
      if (campSolicitud == null) {
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, CampSolicitud campSolicitud) throws Exception,I18NException {
