...
public class DocumentCedentController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.DocumentCedentLocal.JNDI_NAME)
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarDocumentCedentPost(@ModelAttribute @Valid DocumentCedentForm documentCedentForm,
    ...
    try {
      this.setFilesFormToEntity(afm, documentCedent, documentCedentForm); // FILE
      preValidate(request, documentCedentForm, result);
      getWebValidator().validate(documentCedent, result);
      postValidate(request, documentCedentForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String getSessionAttributeFilterForm() {
    return "DocumentCedentWebDB_FilterForm";
  }
  ...
  public void delete(HttpServletRequest request, DocumentCedent documentCedent) throws Exception,I18NException {
