...
public class FormulariController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.FormulariLocal.JNDI_NAME)
  ...
  public String editarFormulariPost(@ModelAttribute @Valid FormulariForm formulariForm,
    ...
    try {
      this.setFilesFormToEntity(afm, formulari, formulariForm); // FILE
      preValidate(request, formulariForm, result);
      getWebValidator().validate(formulari, result);
      postValidate(request, formulariForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, Formulari formulari) throws Exception,I18NException {
