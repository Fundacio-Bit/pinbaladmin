...
public class EmailController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.EmailLocal.JNDI_NAME)
  ...
  public String editarEmailPost(@ModelAttribute @Valid EmailForm emailForm,
    ...
    try {
      preValidate(request, emailForm, result);
      getWebValidator().validate(email, result);
      postValidate(request, emailForm, result);
