...
public class TiquetController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.TiquetLocal.JNDI_NAME)
 ...
 if (!_listSKV.isEmpty())    {
  ...
  public String editarTiquetPost(@ModelAttribute @Valid TiquetForm tiquetForm,
    ...
    try {
      this.setFilesFormToEntity(afm, tiquet, tiquetForm); // FILE
      preValidate(request, tiquetForm, result);
      getWebValidator().validate(tiquet, result);
      postValidate(request, tiquetForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void delete(HttpServletRequest request, Tiquet tiquet) throws Exception,I18NException {
