...
public class EntitatServeiController
  ...
  @EJB(mappedName = org.fundaciobit.pinbaladmin.ejb.EntitatServeiLocal.JNDI_NAME)
  ...
  public String editarEntitatServeiPost(@ModelAttribute @Valid EntitatServeiForm entitatServeiForm,
    ...
    try {
      preValidate(request, entitatServeiForm, result);
      getWebValidator().validate(entitatServei, result);
      postValidate(request, entitatServeiForm, result);
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public String getSessionAttributeFilterForm() {
    return "EntitatServeiWebDB_FilterForm";
  }
  ...
  public void delete(HttpServletRequest request, EntitatServei entitatServei) throws Exception,I18NException {
