...
$(document).ready(function() {
    ...
    $("a.appendAjaxContent").live('click',function(){
    ...
    $(".ui-widget-overlay").live("click", function() {
        ...
        $("input[type=submit].appendAjaxContent").live('click',function(){
        ...
        $("a.clearForm").live('click',function(){
	...
	// Sliding filter
	$('.slidingFilter > a').live('click',function() {
		$('form.filterForm').slideToggle('slow');
	});

	// Button w/multiple sec. actions
	$('.multisimbutton .multiDropdown').live('click',function() {
		$(this).focus();
    ...
    $('.multisimbutton .dropdownList a').live('mousedown',function() {
        divclick = true;
        return false;
    });
    var divclick = false;
	$('.multisimbutton .multiDropdown').live('blur',function() {
	...
	$('.dropdownMenu .dropdown').live('click',function() {
		$(this).focus();
		$(this).toggleClass( 'selected', 0);
		$(this).parent().next('ul').slideToggle('fast');
		$(this).parent().next('ul').position({
	...
	$('.dropdownMenu .dropdownList a').live('mousedown',function() {
            divclick = true;
            return false;
        });
	$('.dropdownMenu .dropdown').live('blur',function() {
            if ( divclick ) return( divclick = false );
		if($(this).hasClass('selected')) {
			$(this).toggleClass( 'selected', 0);
			$(this).parent().next('ul').slideToggle('fast');
