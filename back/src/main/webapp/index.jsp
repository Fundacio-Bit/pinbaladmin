  ...
  if (existsSecureContextStatic == null) {
    try {  
      ...
      if (propData == null) {
        ...
        String value = properties.getProperty("pinbaladmin.clientcert");
...
if (existsSecureContext) {
  ...
  final boolean thisContextIsClientCert = "/pinbaladmins".equals(context);
  
  if (thisContextIsClientCert && "http".equals(scheme)) {
    // Hem de passar a pinbaladmin
    context = "/pinbaladmin";
  } else {
    // Hem de passar a pinbaladmins
    if (!thisContextIsClientCert && "https".equals(scheme)) {
      context ="/pinbaladmins";
    }
  }
