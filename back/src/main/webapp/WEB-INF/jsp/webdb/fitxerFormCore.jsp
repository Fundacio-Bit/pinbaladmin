...
<un:useConstants var="FitxerFields" className="org.fundaciobit.pinbaladmin.model.fields.FitxerFields"/>
        ...
        <tr id="fitxer_mime_rowid">
          <td>
            ...
            <form:input readonly="${ gen:contains(__theForm.readOnlyFields ,FitxerFields.MIME)? 'true' : 'false'}" cssClass="${gen:contains(__theForm.readOnlyFields ,FitxerFields.MIME)? 'input-xxlarge uneditable-input' : 'input-xxlarge'}"  maxlength="100" path="fitxer.mime"   />
