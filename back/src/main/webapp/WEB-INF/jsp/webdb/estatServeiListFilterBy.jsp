...
<un:useConstants var="EstatServeiFields" className="org.fundaciobit.pinbaladmin.model.fields.EstatServeiFields"/>
  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EstatServeiFields.ESTATSERVEIID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="estatServei.estatServeiID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EstatServeiFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="estatServei.nom" var="nom" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EstatServeiFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="estatServei.descripcio" var="descripcio" />
