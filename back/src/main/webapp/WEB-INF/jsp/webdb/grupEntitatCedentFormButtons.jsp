...
<%@ include file="/WEB-INF/jsp/moduls/includes.jsp"%>
  ...
  <div class="navbar-form pull-right">
    ...
    <input type="button" class="btn" onclick="goTo('<c:url value="${contexte}/${__theForm.grupEntitatCedent.grupEntitatCedentID}/cancel"/>')" value="<fmt:message key="genapp.cancel"/>">
    </c:if>
