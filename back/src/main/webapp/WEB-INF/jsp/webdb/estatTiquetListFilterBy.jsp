...
<un:useConstants var="EstatTiquetFields" className="org.fundaciobit.pinbaladmin.model.fields.EstatTiquetFields"/>
  ...
  <div id="FilterDiv" class="well formbox" style="${displayFilterDiv} margin-bottom:3px; margin-left: 1px; padding:3px;">
      ...
      <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EstatTiquetFields.ESTATTIQUETID)}">
            <%-- FILTRE NUMERO --%>      
            <div class="input-prepend input-append" style="padding-right: 4px;padding-bottom: 4px;">
              <span class="add-on"><fmt:message key="estatTiquet.estatTiquetID" />:</span>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,EstatTiquetFields.NOM)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="estatTiquet.nom" var="nom" />
