...
public interface Constants {
 ...
 //   public static final long SOLI_ESTAT_PENDENT = 10;
    ...
    public static final long SOLI_ESTAT_ESMENA_ENVIAR_CONTACTE = 31;
    public static final long SOLI_ESTAT_ESMENA_PENDENT_RESPOSTA = 32;
    public static final long SOLI_ESTAT_ESMENA_PENDENT_REVISAR = 33;
	...
	public static final long[] ESTATS_SOLI = { SOLI_ESTAT_SENSE_ESTAT, SOLI_ESTAT_PENDENT_DISTRIBUCIO,
			...
			SOLI_ESTAT_ESMENES, SOLI_ESTAT_ESMENA_ENVIAR_CONTACTE, SOLI_ESTAT_ESMENA_PENDENT_RESPOSTA, SOLI_ESTAT_ESMENA_PENDENT_REVISAR, SOLI_ESTAT_AUTORITZAT, SOLI_ESTAT_AUTORITZAT_Manual, SOLI_ESTAT_AUTORITZAT_Parcial, SOLI_ESTAT_AUTORITZAT_ESMENES, SOLI_ESTAT_ERROR_ENVIANT_MADRID,
			...
			SOLI_ESTAT_AUTORITZAT_ERROR_ENVIANT_MADRID, SOLI_ESTAT_REVISIO };
