...
public class TipusProcediments {
    ...
    static {
        ...
        tipusProcediments.add(new TipusProcediment(4, "Ayudas, Becas y Subvenciones", "Ajudes, Beques i Subvencions"));
        ...
        tipusProcediments.add(new TipusProcediment(7, "Convenios de colaboración y comunicaciones administrativas",
                "Convenis de col·laboració i comunicacions administratives"));
        tipusProcediments
                .add(new TipusProcediment(8, "Gestión Económica y Patrimonial", "Gestió Econòmica i Patrimonial"));
        ...
        tipusProcediments
                .add(new TipusProcediment(15, "Responsabilidad patrimonial y otras solicitudes de indemnización",
