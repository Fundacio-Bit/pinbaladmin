...
import org.fundaciobit.pinbaladmin.persistence.TramitJConsentJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class TramitJConsentEJB extends TramitJConsentJPAManager implements TramitJConsentService {
    ...
    public void delete(TramitJConsent instance) {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(TramitJConsent instance,  FitxerService fitxerEjb)
            throws I18NException {

        java.util.ArrayList<Long> fitxers = new java.util.ArrayList<Long>();
        fitxers.add(instance.getAdjuntID());
    ...
    public TramitJConsentJPA findByPrimaryKey(Long _ID_) {
        return (TramitJConsentJPA)super.findByPrimaryKey(_ID_);
    }
