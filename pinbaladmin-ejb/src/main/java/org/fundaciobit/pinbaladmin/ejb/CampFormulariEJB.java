...
import org.fundaciobit.pinbaladmin.persistence.CampFormulariJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class CampFormulariEJB extends CampFormulariJPAManager implements CampFormulariService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(CampFormulari instance,  FitxerService fitxerEjb)
