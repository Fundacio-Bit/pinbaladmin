...
import org.fundaciobit.pinbaladmin.persistence.DocumentCedentJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class DocumentCedentEJB extends DocumentCedentJPAManager implements DocumentCedentService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(DocumentCedent instance,  FitxerService fitxerEjb)
