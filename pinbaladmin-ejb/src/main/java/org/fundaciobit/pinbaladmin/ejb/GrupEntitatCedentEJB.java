...
import org.fundaciobit.pinbaladmin.persistence.GrupEntitatCedentJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class GrupEntitatCedentEJB extends GrupEntitatCedentJPAManager implements GrupEntitatCedentService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(GrupEntitatCedent instance,  FitxerService fitxerEjb)
