...
import org.fundaciobit.pinbaladmin.persistence.EventJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class EventEJB extends EventJPAManager implements EventService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(Event instance,  FitxerService fitxerEjb)
