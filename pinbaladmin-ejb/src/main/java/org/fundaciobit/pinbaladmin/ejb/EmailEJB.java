...
import org.fundaciobit.pinbaladmin.persistence.EmailJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class EmailEJB extends EmailJPAManager implements EmailService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(Email instance,  FitxerService fitxerEjb)
