...
import org.fundaciobit.pinbaladmin.persistence.EntitatServeiJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class EntitatServeiEJB extends EntitatServeiJPAManager implements EntitatServeiService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(EntitatServei instance,  FitxerService fitxerEjb)
