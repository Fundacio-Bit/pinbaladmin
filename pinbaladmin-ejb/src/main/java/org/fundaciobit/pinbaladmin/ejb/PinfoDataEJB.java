...
import org.fundaciobit.pinbaladmin.persistence.PinfoDataJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class PinfoDataEJB extends PinfoDataJPAManager implements PinfoDataService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(PinfoData instance,  FitxerService fitxerEjb)
