...
import org.fundaciobit.pinbaladmin.persistence.ModificacioSolicitudJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class ModificacioSolicitudEJB extends ModificacioSolicitudJPAManager implements ModificacioSolicitudService {
    ...
    public void delete(ModificacioSolicitud instance) {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(ModificacioSolicitud instance,  FitxerService fitxerEjb)
            throws I18NException {

        java.util.ArrayList<Long> fitxers = new java.util.ArrayList<Long>();
        fitxers.add(instance.getDoCconsentimentID());
