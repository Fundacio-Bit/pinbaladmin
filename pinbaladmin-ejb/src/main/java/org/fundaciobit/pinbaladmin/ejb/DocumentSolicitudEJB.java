...
import org.fundaciobit.pinbaladmin.persistence.DocumentSolicitudJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class DocumentSolicitudEJB extends DocumentSolicitudJPAManager implements DocumentSolicitudService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(DocumentSolicitud instance,  FitxerService fitxerEjb)
