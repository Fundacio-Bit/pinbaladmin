...
import org.fundaciobit.pinbaladmin.persistence.DocumentEntitatJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class DocumentEntitatEJB extends DocumentEntitatJPAManager implements DocumentEntitatService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(DocumentEntitat instance,  FitxerService fitxerEjb)
