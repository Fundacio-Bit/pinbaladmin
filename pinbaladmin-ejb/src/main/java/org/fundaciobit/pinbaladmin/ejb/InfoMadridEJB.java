...
import org.fundaciobit.pinbaladmin.persistence.InfoMadridJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class InfoMadridEJB extends InfoMadridJPAManager implements InfoMadridService {

    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void delete(InfoMadrid instance) {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(InfoMadrid instance,  FitxerService fitxerEjb)
