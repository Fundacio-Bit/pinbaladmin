...
import org.fundaciobit.pinbaladmin.persistence.SolicitudJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class SolicitudEJB extends SolicitudJPAManager implements SolicitudService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(Solicitud instance,  FitxerService fitxerEjb)
