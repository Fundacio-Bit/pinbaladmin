...
import org.fundaciobit.pinbaladmin.persistence.EstatServeiJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class EstatServeiEJB extends EstatServeiJPAManager implements EstatServeiService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(EstatServei instance,  FitxerService fitxerEjb)
