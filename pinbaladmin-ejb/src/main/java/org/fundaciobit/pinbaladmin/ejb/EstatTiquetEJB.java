...
import org.fundaciobit.pinbaladmin.persistence.EstatTiquetJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class EstatTiquetEJB extends EstatTiquetJPAManager implements EstatTiquetService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(EstatTiquet instance,  FitxerService fitxerEjb)
