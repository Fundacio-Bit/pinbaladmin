...
import org.fundaciobit.pinbaladmin.persistence.AreaJPAManager;

import org.fundaciobit.pinbaladmin.commons.utils.Constants;

@Stateless
public class AreaEJB extends AreaJPAManager implements AreaService {
    ...
    @Override
    @RolesAllowed({Constants.ROLE_EJB_FULL_ACCESS, Constants.ROLE_EJB_BASIC_ACCESS, Constants.ROLE_EJB_WS_ACCESS})
    public void deleteIncludingFiles(Area instance,  FitxerService fitxerEjb)
