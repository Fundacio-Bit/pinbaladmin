...
public class SolicitudLogicaEJB extends SolicitudEJB implements SolicitudLogicaService {
  ...
  public Map<Long, List<SolicitudDTO>> getSolicitudsByServei(Collection<Long> serveiIds) {
    ...
    for (Object[] result : resultList) {
      ...
      SolicitudDTO solicitudDTO = new SolicitudDTO((Long) result[1], (String) result[2],
          (String) result[3], (Long) result[4]);
  ...
  public Set<Long> deleteFull(Long solicitudId, boolean deleteFiles) throws I18NException {
    ...
    {
      List<Long> list = solicitudServeiLogicaEJB.executeQuery(
          SolicitudServeiFields.SERVEIID.select,
    ...
    {
      List<Long> documentsIds = documentSolicitudLogicaEjb.executeQuery(
  ...
  protected Fitxer createFile(FitxerService fitxerEJB, String fileName, String mime, String descripcio, byte[] data) throws I18NException {
