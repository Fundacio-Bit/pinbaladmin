...
import org.fundaciobit.pinbaladmin.logic.utils.pinbalutils.PinbalUtilsCommon.InfoContacte;
...
public class PinbalUtilsModificacio extends PinbalUtilsCommon {

	public PinbalUtilsModificacio() {
		// Constructor vacío
	}
...
//				contingut = "hola".getBytes();
		...
		private Servicios getServicios(SolicitudJPA soli) throws Exception {
			...
			for (SolicitudServeiJPA ss : serveisDeLaSolicitud) {
				...
				estatPendentMadrid |= ss.getEstatSolicitudServeiID() == Constants.ESTAT_SOLICITUD_SERVEI_PENDENENT_ENVIAR_MODIFICACIO_MADRID;
